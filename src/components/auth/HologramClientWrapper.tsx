...
const HologramCanvas = dynamic(
  ...
  { 
    ssr: false,
    loading: () => (
      <div className="w-full h-full bg-gradient-to-br from-cyan-500/20 to-purple-500/20 animate-pulse rounded-lg flex items-center justify-center">
        <div className="text-cyan-400 text-sm">Loading Hologram...</div>
      </div>
    )
  }
);
